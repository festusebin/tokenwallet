...
class App extends Component {
  ...
  newApprove20 = (index) => {
    this.setState({
      approveDetail20: this.setState.tokens20[index]
    })
  };

  newApprove721 = (index) => {
    this.setState({
      approveDetail721: this.setState.tokens721[index]
    })
  };
      ...
      return (
        <div>
          ...
          <Container
            ...
            newTransfer20={this.state.newTransfer20}
            newTransfer721={this.state.newTransfer721}
            newApprove20={this.state.newApprove20}
            newApprove721={this.state.newApprove721}
            newMint20={this.state.newMint20}
            newMint721={this.state.newMint721}
